...
public class OverlayService extends Service implements View.OnTouchListener {
    private static void debugLog(Context context, String tag, String msg) {
    ...
    public void onDestroy() {
        debugLog(this, "OverLay", "Destroying the overlay window service");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        isRunning = true;
        debugLog(this, "onStartCommand", "Service started");
        ...
        int layoutWidth = resolveOverlayWidth(WindowSetup.width);
        int layoutHeight = resolveOverlayHeight(WindowSetup.height);
